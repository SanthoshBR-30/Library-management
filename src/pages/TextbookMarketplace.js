...
//   // Function to fetch textbooks based on selected filters
...
//         console.log("Fetched textbooks:", data);
//         if (Array.isArray(data)) {
//           // Filter valid textbooks (those with a filename)
//           setTextbooks(data.filter((book) => book && book.filename));
//         } else {
//           setTextbooks([]);
//         }
...
//   // Fetch textbooks when filters change
//   useEffect(() => {
//     fetchTextbooks();
//   }, [syllabusScheme, college, department, semester, subject]);
...
//                     key={book._id} 
//                     textbook={book} 
//                     // Pass the server URL for download links
//                     downloadUrl={`http://localhost:5000/api/textbooks/download/${book.filename}`}
//                   />
//                 ))}
//               </div>
//             ) : (
